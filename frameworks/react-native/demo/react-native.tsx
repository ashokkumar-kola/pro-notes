...
Ionicons	
import Icon from 'react-native-vector-icons/Ionicons'	iOS-style icons, clean and modern

FontAwesome5	
import { FontAwesome5 } from '@expo/vector-icons'	Popular icons (social, UI, layout)

MaterialIcons / MaterialCommunityIcons	
import { MaterialCommunityIcons } from '@expo/vector-icons'	Google-style, large variety (best for UI/tools)

📦 Install vector icons (if not using Expo)
